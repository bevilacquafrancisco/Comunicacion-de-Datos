...
Comunicación de Datos — 4.° año — 1.° Cuatrimestre 2025
...
- **Investigación de protocolos IR:** comparar NEC, RC-5 y Sony SIRC; seleccionar uno y justificar la elección.
...
**Bandera mágica `0xA5`:** al encenderse, si el byte en la dirección de control no es exactamente `0xA5` (el valor por defecto de una EEPROM virgen es `0xFF`), los datos se consideran inválidos y se aplica el estado seguro por defecto: Esclavo → negro `(0,0,0)`; Maestro → índice 0 (Rojo).
...
│
├── docs/
│   └── Bevilacqua_Clement_CdD_T2_25.pdf   — Informe técnico completo
│
├── media/
│   ├── circuito_esclavo.jpg
│   ├── circuito_maestro.jpg
│   ├── osciloscopio_trama_cmd.jpg
│   ├── osciloscopio_trama_ack.jpg
│   └── osciloscopio_handshaking.jpg
│
└── README.md
```
...
2. Cada uno muestra en su LED el último color guardado en EEPROM (o negro si es el primer uso).
...
Comunicación de Datos — 2025

---

> 📄 **Informe técnico completo:** [`docs/Bevilacqua_Clement_CdD_T2_25.pdf`](docs/Bevilacqua_Clement_CdD_T2_25.pdf)  
> 🎬 **Videos de funcionamiento:** [ insertar links ]  
> 📦 **Simulación Wokwi:** [ insertar link ]
